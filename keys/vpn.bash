...
dh dh2048.pem
server-brigde 172.16.10.1 255.255.255.0 172.16.10.20 172.16.10.220
...
# iptables -I FORWARD -i tun+ -o $nic -m state --state RELATED,ESTABLISHED -j ACCEPT
# iptables -I FORWARD -i $nic -o tun+ -m state --state RELATED,ESTABLISHED -j ACCEPT
